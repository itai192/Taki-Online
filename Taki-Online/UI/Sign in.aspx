    ...
    <asp:Panel ID="Panel1" runat="server">
        <asp:Table ID="Table1" runat="server">
            ...
            <asp:TableRow runat="server">
                ...
                <asp:TableCell runat="server"><asp:TextBox ID="password" runat="server"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please Insert A Password" ControlToValidate="password" SetFocusOnError="True"></asp:RequiredFieldValidator></asp:TableCell>
            </asp:TableRow>
        </asp:Table>
        <asp:Button ID="SignIn" runat="server" Text="SIGN IN" /><asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="CustomValidator"></asp:CustomValidator>
        <hr />
